<template>
  <div class="dashboard-detail">
    <t-card title="本月租猫申请情况" class="dashboard-detail-card" :bordered="false">
      <t-row :gutter="[16, 16]">
    ...
    <t-row :gutter="[16, 16]" class="row-margin">
      <t-col :xs="12" :xl="9">
        <t-card :class="{ 'dashboard-detail-card': true }" title="出租猫咪申请趋势" subtitle="(件)" :bordered="false">
          <template #actions>
            <t-date-range-picker
              style="width: 250px"
    ...
    <t-card :class="{ 'dashboard-detail-card': true }" title="出租猫咪满意度分布" class="row-margin" :bordered="false">
      <template #actions>
        <t-date-range-picker
