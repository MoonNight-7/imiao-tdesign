...
export default [
  ...
  // },
  {
    ...
    name: 'shop',
    component: Layout,
    redirect: '/shop/members',
    meta: {title: '小店管理', icon: 'shop'},
    children: [
      {
        path: 'members',
        name: 'ShopMembers',
        component: () => import('@/pages/shop/members/index.vue'),
        meta: {title: '小店成员'},
      },
      {
        path: 'management',
        name: 'ShopManagement',
        component: () => import('@/pages/shop/management/index.vue'),
        meta: {title: '店员管理'},
      },
      {
        path: 'addAdmin',
        name: 'ShopAddAdmin',
        component: () => import('@/pages/shop/add-admin/index.vue'),
        meta: {title: '新增成员'},
      },
    ]
  },
  {
    ...
    name: 'customer',
    component: Layout,
    meta: {title: '客户管理', icon: 'usergroup'},
  ...
  },
  {
    path: '/cat',
    name: 'cat',
    meta: {title: '猫咪中心', icon: 'bulletpoint'},
    component: Layout,
    redirect: '/cat/list',
    children: [
      {
        path: 'list',
        name: 'CatList',
        component: () => import('@/pages/cat/list/index.vue'),
        meta: {title: '猫咪列表'},
      },
      {
        path: 'add-category',
        name: 'CatAddCategory',
        component: () => import('@/pages/cat/add-category/index.vue'),
        meta: {title: '新增类别'},
      },
      {
        path: 'entry',
        name: 'CatEntry',
        component: () => import('@/pages/cat/entry/index.vue'),
        meta: {title: '猫咪入店'},
      }
    ]
  }
